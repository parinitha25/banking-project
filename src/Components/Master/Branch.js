...
class Branch extends Component{
    ...
    validate=()=>{
        ...
        if(this.state.branch_place.trim()=== ''){
            ...
            errors.branchPlaceError = "Branch Place is not correct";
        }   
        ...
        else if(!this.state.phone_no.match(/^[0-9]{3}[-][0-9]{3}[-][0-9]{4}$/)){
            errors.phoneNoError = "Phone Number is not correct";
        }
        if(this.state.email.trim()=== ''){
            errors.emailError='Email  is required.';
        }
        else if(!this.state.email.match(/^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$/)){
                                                ...
                                                <div className="row" style={{padding:"10px"}}>
                                                    ...
                                                    <div className="form-group col-md-3 col-sm-3">
                                                        <label className="control-label" for="city">Village</label>
                                                            ...
                                                            {this.state.errors && <div style={{color:"white"}}>{this.state.errors.villageError}</div>}						
                                                    </div>
                                                    <div className="form-group col-md-3 col-sm-3" style={{marginTop:"20px"}}>
                                                    ...
                                                    <div className="form-group col-md-3 col-sm-3" style={{marginTop:"20px"}}> 
                                                        ...
                                                        <input   class="form-control"   placeholder="Pincode" type="text" name="pincode" maxlength="5" value={this.state.pincode} onChange={this.handleChange}/> 
                                                    ...
                                                    <div className="form-group col-md-3 col-sm-3" style={{marginTop:"20px"}}>
                                                        ...
                                                        <input   class="form-control"   placeholder="Phone Number" type="text" name="phone_no" maxlength="12" value={this.state.phone_no} onChange={this.handleChange}/> 
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="example1">
                                        <thead>
                                            <tr style={{color:"#3869ae"}}>
                                                ...
                                                <th style={{textAlign:"center"}}>Branch<span style={{visibility:"hidden"}}>_</span>Name</th>
                                                <th style={{textAlign:"center"}}>Branch<span style={{visibility:"hidden"}}>_</span>Place</th>
                                                <th style={{textAlign:"center"}}>Pincode</th>
                                                <th style={{textAlign:"center"}}>Phone<span style={{visibility:"hidden"}}>_</span>Number</th>
                                                <th style={{textAlign:"center"}}>Mobile<span style={{visibility:"hidden"}}>_</span>Number</th>
                                                <th style={{textAlign:"center"}}>Contact<span style={{visibility:"hidden"}}>_</span>Name</th>
                                                <th style={{textAlign:"center"}}>Email</th>
                                                <th style={{textAlign:"center"}}>Enable<span style={{visibility:"hidden"}}>_</span>/<span style={{visibility:"hidden"}}>_</span>Disable</th>
